...
function functionFinished() {
  ...
  fetch(
    `https://v3.football.api-sports.io/fixtures?status=FT&date=${fecha}&timezone=${timeZone}`,
    {
      method: "GET",
      headers: {
        "x-rapidapi-host": "v3.football.api-sports.io",
...
function functionNext() {
  ...
  fetch(
    `https://v3.football.api-sports.io/fixtures?date=${fecha}&status=NS&timezone=${timeZone}`,
    {
      method: "GET",
      headers: {
        "x-rapidapi-host": "v3.football.api-sports.io",
